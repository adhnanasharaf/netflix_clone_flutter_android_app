...
mixin _$HomeState {
  ...
  List<HotAndNewData> get pastYearMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get trendigMovieList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> trendigMovieList,
...
class _$HomeStateCopyWithImpl<$Res> implements $HomeStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? trendigMovieList = freezed,
    ...
    return _then(_value.copyWith(
      ...
      trendigMovieList: trendigMovieList == freezed
          ? _value.trendigMovieList
          : trendigMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> trendigMovieList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        _trendigMovieList = trendigMovieList,
  ...
  final List<HotAndNewData> _trendigMovieList;
  @override
  List<HotAndNewData> get trendigMovieList {
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_trendigMovieList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendigMovieList: $trendigMovieList, tenseDramasMovieList: $tenseDramasMovieList, southIndianMovieList: $southIndianMovieList, trendingTvList: $trendingTvList, isLoading: $isLoading, hasError: $hasError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._trendigMovieList, _trendigMovieList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_trendigMovieList),
